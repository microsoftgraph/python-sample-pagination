"""pagination samples for Microsoft Graph"""
...
def login():
    ...
    MSGRAPH.login(login_redirect='/pagination?endpoint=' + endpoint)
...
def pagination():
    ...
    graphdata = MSGRAPH.get(endpoint, headers=MSGRAPH.headers()).json()
